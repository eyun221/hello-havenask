...
template <class _Tp>
struct __coroutine_traits_sfinae<
    _Tp, typename future_lite::detail::__void_t<typename _Tp::promise_type>::type>
{
...
public:
    ...
    FL_CONSTEXPR coroutine_handle() noexcept : __handle_(nullptr) {}

    
    FL_CONSTEXPR coroutine_handle(std::nullptr_t) noexcept : __handle_(nullptr) {}
    ...
    FL_CONSTEXPR void* address() const noexcept { return __handle_; }

    
    FL_CONSTEXPR explicit operator bool() const noexcept { return __handle_; }
...
public:
  ...
  FL_CONSTEXPR explicit operator bool() const noexcept { return true; }
  FL_CONSTEXPR bool done() const noexcept { return false; }

  FL_CONSTEXPR void operator()() const noexcept {}
  FL_CONSTEXPR void resume() const noexcept {}
  FL_CONSTEXPR void destroy() const noexcept {}
