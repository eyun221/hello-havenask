...
public:
    ...
    public:
        ...
        handle_t await_suspend(std::experimental::coroutine_handle<> continuation) noexcept {
...
private:
    ...
    explicit AsyncGenerator(std::experimental::coroutine_handle<promise_type> coro) noexcept
        : coro_(coro) {}
