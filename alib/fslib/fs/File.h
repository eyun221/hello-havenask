...
#include "fslib/fs/coro/AsyncFileOperator.h"
...
public:
    ...
    AsyncFileOperator pread(IOController* controller, void* buffer, size_t length,
                            off_t offset);
    AsyncFileOperator preadv(IOController* controller, const iovec* iov, int iovcnt,
                             off_t offset);
    AsyncFileOperator pwrite(IOController* controller, void* buffer, size_t length,
                             off_t offset);
    AsyncFileOperator pwritev(IOController* controller, const iovec* iov, int iovcnt,
                              off_t offset);
     ...
     */
    virtual ErrorCode ioctl(IOCtlRequest request, ...) {
        return EC_NOTSUP;
    }
