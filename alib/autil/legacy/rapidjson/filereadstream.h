...
#ifndef AUTIL_RAPIDJSON_FILEREADSTREAM_H_
#define AUTIL_RAPIDJSON_FILEREADSTREAM_H_
...
AUTIL_RAPIDJSON_DIAG_OFF(missing-noreturn)
#endif
...
public:
    ...
    */
    FileReadStream(std::FILE* fp, char* buffer, size_t bufferSize) : fp_(fp), buffer_(buffer), bufferSize_(bufferSize), bufferLast_(0), current_(buffer_), readCount_(0), count_(0), eof_(false) { 
        ...
        AUTIL_RAPIDJSON_ASSERT(bufferSize >= 4);
        Read();
    }
