#ifndef AUTIL_LEGACY_JSON_H
#define AUTIL_LEGACY_JSON_H
...
namespace autil{ namespace legacy { namespace json
{
    ...
    Any ParseJson(a_Istream &);     /// Json Parser
    void ToStream(
            const Any& a,
            a_Ostream &os,
    ...
    /// for ease of use for std io.
    inline Any ParseJson(std::istream &is)
    {
        a_IstreamStd is2(is);
    ...
    {
        a_OstreamStd os2(os);
        return ToStream(a, os2, isCompact, prefix);
    }
