#ifndef AUTIL_RAPIDJSON_RAPIDJSONHELPER_H
#define AUTIL_RAPIDJSON_RAPIDJSONHELPER_H
...
{
    autil_rapidjson::StringBuffer buffer;
    autil_rapidjson::Writer<autil_rapidjson::StringBuffer> writer(buffer);
    value.Accept(writer);
...
#endif //AUTIL_RAPIDJSON_RAPIDJSONHELPER_H
